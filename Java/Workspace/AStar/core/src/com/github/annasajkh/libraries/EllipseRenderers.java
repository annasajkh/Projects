...
public class EllipseRenderers extends ShapeRenderers
{
    ...
    public void renderAll(Ellipse[][] ellipses)
    {
        ...
        for (Ellipse[] row : ellipses)
        {
            for (Ellipse ellipse : row)
            {
                shapeRenderer.setColor(ellipse.modulate);
                if (ellipse.centered)
                {
                ...
                else
                {
                    if (!ellipse.dontRender)
                    {
                        shapeRenderer.ellipse(ellipse.position.x, ellipse.position.y, ellipse.size.width,
                                ellipse.size.height, ellipse.rotation);
                    }
                }
            }
        }
