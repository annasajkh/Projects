let musuh2 = {
    ...
    sudahKena: false,
    cetak() {
        if (collideCircleRect(bola.pos.x, bola.pos.y, 10, musuh2.x, musuh2.y, 100, 20)) {
            this.sudahKena = true
        }
        if (!this.sudahKena) {
            if (bola.pos.x < 350) {
...
class Bola {
    ...
    cetak() {
        ...
        if (this.pos.x < 10) {
            this.pos.x = 350
            this.pos.y = 250
            this.dir.x = -10 + Math.random() * 20
            this.dir.y = -10 + Math.random() * 20
            this.kecepatan = 4
            skor.musuh += 1
        }
        ...
        if (this.pos.x < 350) {
            if (collideCircleRect(this.pos.x, this.pos.y, 10, musuh2.x, musuh2.y, 100, 20)) {
                this.kecepatan += 0.05
                if (this.pos.x > musuh2.x) {
                    this.dir.y = this.dir.y
